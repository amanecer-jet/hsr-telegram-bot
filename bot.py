    ...
    if builds:
        for build in builds:
            ...
            if art_path and os.path.exists(art_path):
                with open(art_path, "rb") as photo:
                    await callback.message.answer_photo(photo, caption=build_text, reply_markup=build_keyboard())
            else:
                await callback.message.answer(build_text, reply_markup=build_keyboard())
        return
