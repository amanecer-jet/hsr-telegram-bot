...
def _load_subscribers() -> List[int]:
    """Load subscribers list from JSON file (synchronous)."""
...
# === Helper: fetch recent articles within n days ===

async def fetch_recent_articles(days_back: int = 2):
    """Return list of tuples (art_meta, details) for articles newer or equal to now - days_back."""
